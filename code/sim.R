'Simulate data for Type-1 items
...
if (interactive()) {
    a = docopt::docopt(doc, args = list("170", "99", "-o", "made/train.RDS") )
} else {
    a = docopt::docopt(doc)
}
# print(a)
...
gp     = rep(1:2, each=n_subj/2)  # groups. Hearing loss: 1; Typical Hearing: 2
...
# Item parameters
item_type = c( rep(-1,4), rep(1,16) )  # -1: age-unrestricted items
